...
class BringFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        for ($i = 1; $i <= 500; $i++) {
            $bring = new Bring();
            $bring->setAsh($faker->randomFloat(2, 0, 19));
            $bring->setCalcium($faker->randomFloat(2, 0, 100));
            $bring->setCalorie($faker->randomFloat(2, 0, 100));
            $bring->setFiber($faker->randomFloat(2, 0, 19));
            $bring->setHumidity($faker->randomFloat(2, 0, 19));
            $bring->setLipid($faker->randomFloat(2, 0, 19));
            ...
            $bring->setProtein($faker->randomFloat(2, 0, 19));
