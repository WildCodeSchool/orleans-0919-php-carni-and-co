let myColor = ['#39ca74', '#e54d42', '#d68910', '#3999d8', '#808080' ,'#800080'];
let myLabel = ['Protéines', 'Lipides', 'Cendres', 'Fibres', 'Humidités', 'Glucides'];

let bringElement = document.getElementById('graph-bring');
...
function plotData() {
    ...
    for (let i = 0; i < bring.length; i++) {
        ...
        let flip = 0;
        let textOffset = 0;
        let percentage = (bring[i] / myTotal) * 100;
